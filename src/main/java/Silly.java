...
public class Silly implements Comparable<Silly>{
    ...
    /*
     * TO-DO (Task 1): Create another constructor that takes in TWO parameters,
     ...
     *
     * @param first first string parameter for constructing the name
     * @param second second string parameter for constructing the name
     */
    ...
    public static void main(String[] args) {
        ...
        /*
         * TO-DO (Task 2): Below are a bunch of calls to countStatic using
    ...
    public int compareTo(Silly other) {
        /*
         * TO-DO (Task 5): Implement the body of this method.
